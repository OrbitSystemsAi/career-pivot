...
const steps = [
  ...
  {
    number: "04",
    title: "Bring it back to OSai",
    description:
      "Return to Network with Connections.csv ready. OSai will use the file to identify confirmed contacts and possible career-relevant relationships.",
  },
];
        ...
        <header className="bg-[linear-gradient(135deg,#102f39_0%,#1b414c_48%,#2b6874_100%)] px-6 py-8 text-white sm:px-10 lg:px-14 lg:py-12">
          ...
          <div className="mt-10 max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-[#d3e1e4] sm:text-lg">
              ...
              prepare that file for OSai. Your account remains under your
          ...
          <aside className="mt-6 rounded-3xl bg-[#e8f2f3] p-6 sm:flex sm:items-center sm:justify-between sm:gap-8 sm:p-8">
            <div>
              <h2 className="text-lg font-semibold text-[#102f39]">
                What OSai will—and will not—receive
              </h2>
              <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
                ...
                give OSai your password, messages, or permission to act on
                LinkedIn for you.
              </p>
            </div>
            <a
